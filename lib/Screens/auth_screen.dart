  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (error.toString().contains('EMAIL_EXISTS')) {
        ...
        errorMessage = 'Password entered is too weak';
      } else if (error.toString().contains('EMAIL_NOT_FOUND')) {
        errorMessage = 'Email entered is not registered';
      ...
      var errorMessage =
          'Authentication failed kindly check and confirm user\'s credentials';
      _errorDialog(errorMessage);
      setState(() {
        _isLoading = false;
      });
